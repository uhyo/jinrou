...
exports.gachaData =
    ...
    4: ["Poisoner", "Merchant", "MadWolf", "Light", "Cat", "Witch", "Dictator",
        ...
        "SantaClaus", "Baker", "SpiritPossessed", "Hunter", "Idol", "Elementaler"]
