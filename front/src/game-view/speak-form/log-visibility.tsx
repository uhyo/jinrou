 ...
 */
export class LogVisibilityControl extends React.PureComponent<IPropLogVisibility, {}> {
    public render() {
        const {
            i18n,
            visibility,
            ...
            >{
                ...
                >
                    <option
                        value='all'
                    >
                        {t('speak.logVisibility.all')}
                    </option>
                    <option
                        value='today'
                    >
                        {t('speak.logVisibility.today')}
                    </option>
                    <optgroup
                        label={t('speak.logVisibility.onedayLabel')}
                    >{
                        [...intRange(1, day)]
                        .map(day=> {
                            return (<option
